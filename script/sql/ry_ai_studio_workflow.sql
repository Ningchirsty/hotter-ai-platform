-- ------------------------------------------------------------------
-- AI 视频工作流版本表（目标结构，后端 ruoyi-ai 视频模块实现时启用）
-- 契约源文件：script/workflows/video-workflow-contracts.json（唯一权威）
-- 设计依据：comfyui搭建/docs/04-data-model-and-task-state.md §ai_workflow_version
-- 说明：
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='AI 视频工作流版本（7 能力 × 底模绑定）';
