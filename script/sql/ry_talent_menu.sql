...
insert into sys_menu values(1762000000000001107, '导入简历',     1762000000000000101, 7, '', '', '', 'N', 'Y', 'F', '0', '0', 'talent:profile:import',  '#', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '本地抽取简历字段并确认建档，不调用外部解析服务');
...
insert into sys_role_menu values (1762100000000000001, 1762000000000001107);
...
insert into sys_role_menu values (1762100000000000002, 1762000000000001107);
...
insert into sys_role_menu values (1762100000000000003, 1762000000000001107);
...
insert into sys_role_menu values (1762100000000000004, 1762000000000001107);
