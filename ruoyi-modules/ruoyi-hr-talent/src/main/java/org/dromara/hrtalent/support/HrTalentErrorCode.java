...
public interface HrTalentErrorCode {
     ...
     * 招聘需求不存在（已删除或主键非法）。
     */
    String HR_DEMAND_001 = "HR_DEMAND_001";

    /**
     * 招聘需求状态流转不合法（违反 §4.1 状态机）。
     */
    String HR_DEMAND_002 = "HR_DEMAND_002";

    /**
     * 招聘需求版本冲突：已被其他用户并发修改（§9.6 乐观锁）。
     */
    String HR_DEMAND_003 = "HR_DEMAND_003";

    /**
     * 仅草稿状态的招聘需求允许删除。
     */
    String HR_DEMAND_004 = "HR_DEMAND_004";

    /**
     * 暂停、复开、关闭招聘需求未填写原因。
     */
    String HR_DEMAND_005 = "HR_DEMAND_005";
     ...
     * 中文提示：招聘需求不存在。
     */
    String MSG_HR_DEMAND_001 = "招聘需求不存在";

    /**
     * 中文提示：招聘需求状态流转不合法。
     */
    String MSG_HR_DEMAND_002 = "招聘需求状态流转不合法";

    /**
     * 中文提示：招聘需求已被其他用户修改，请刷新后重试。
     */
    String MSG_HR_DEMAND_003 = "招聘需求已被其他用户修改，请刷新后重试";

    /**
     * 中文提示：仅草稿状态的招聘需求可以删除。
     */
    String MSG_HR_DEMAND_004 = "仅草稿状态的招聘需求可以删除";

    /**
     * 中文提示：暂停、复开、关闭招聘需求必须填写原因。
     */
    String MSG_HR_DEMAND_005 = "暂停、复开、关闭招聘需求必须填写原因";
