...
集团 AI 数智化平台，以 RuoYi-Vue-Plus v6.0.0 为后端基线。业务范围与实施约束见
[`docs/AI平台代码仓构建包-v1.1.md`](docs/AI平台代码仓构建包-v1.1.md)，适配设计见
[`docs/AI平台-RuoYi-Vue-Plus-v6.0.0适配设计-v0.1.md`](docs/AI平台-RuoYi-Vue-Plus-v6.0.0适配设计-v0.1.md)。
